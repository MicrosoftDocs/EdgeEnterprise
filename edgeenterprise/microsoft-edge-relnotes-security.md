...
Microsoft has released the latest**Microsoft Edge Stable Channel (Version 83.0.416.12)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/ADV200002).
