...
- Files that are unknown show a warning to let the user know that the download doesn't have a known footprint and advising caution. The next screenshot is an example of a warning for an unknown file.
